...
public class LibraryManagement {
    public static void main(String[] args) {
        ...
        LibraryItem book = new Book("BOOK1", "Java Programming", "Annie Frank");
        LibraryItem magazine = new Magazine("MAGAZINE1", "Modelling", "Anshu Priya");
        LibraryItem dvd = new DVD("DVD1", "Song", "Shamiksha");
        ...
        reservableBook.reserveItem("khushi");

        Reservable reservableMagazine = (Reservable) magazine;
        reservableMagazine.reserveItem("Nimish");

        Reservable reservableDVD = (Reservable) dvd;
        reservableDVD.reserveItem("Prateek");
