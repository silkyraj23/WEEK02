...
public class CompanyManagementSystem {
    public static void main(String[] args) {
        ...
        company.addEmployeeToDepartment("Engineering", "Shamiksha");
        company.addEmployeeToDepartment("Engineering", "Anshu");
        company.addEmployeeToDepartment("Human Resources", "Silky");
        // Display company details
